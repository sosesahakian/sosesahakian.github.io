...
import voistrapHomeImg from '../../Images/Voistrap/Home.png';
import voistrapMeetingsImg from '../../Images/Voistrap/Meetings.png';
import voistrapPeopleImg from '../../Images/Voistrap/People.png';
import voistrapScoreImg from '../../Images/Voistrap/Score.png';


const VoistrapPhoneHome = styled.img.attrs(props => ({
  transform: `translate(0px,-${(props.scroll) * 15}%)`,
  }),`
